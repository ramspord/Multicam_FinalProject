    ...
    <body>
		...
		<center>
            ...
            <div class="card text-white bg-secondary my-5 py-4 text-center">
                ...
                <input type="submit" class="btn btn-outline-dark btn-lg" id="bookmarkList" value="즐겨찾기 보기">
              </form>
                <c:forEach  var="article" items="${bookmarkList }" varStatus="articleNum" >
                  <div class="d-flex">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <div id="ttsmgphone" class="btn btn-outline-dark btn-lg" style="cursor:pointer;" onclick="tts2(this);">소리</div>
                                                <a href="${path}/deleteBookmark.do?user_text=${article.user_text}" class="btn btn-outline-dark btn-lg" style="cursor:pointer;">삭제</a>
                                               </div>                                            
                                        </div>                               
    </c:forEach>
                </div>
