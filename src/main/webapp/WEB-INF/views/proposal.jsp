...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    <div class="text-center mb-5">
                        ...
                        <p class="lead fw-normal text-muted mb-0">고객 건의 게시판입니다</p>
                    </div>
                    <div class="row gx-5">
                        <div class="col-xl-8">
                            <!-- FAQ Accordion 1-->
                        ...
                        <div class="col-xl-4">
                            <div class="card border-0 bg-light mt-xl-5">
                                ...
                                <c:if test="${memberVO.user_type eq 'admin' || memberVO.user_type eq 'U'}">
                                <a class="btn btn-primary" href="writeProposal">글쓰기</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
    	...
    	function del(btn){
            ...
            form.setAttribute("action", "deleteProposal"); //요청 보낼 주소
