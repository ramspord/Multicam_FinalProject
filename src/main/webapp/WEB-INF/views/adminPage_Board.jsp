                            ...
                            <table border="1" class="table table-striped">
								...
								<c:forEach items="${boardlist }" var="boardlist">
									<tr>
										...
										<td><fmt:formatDate value="${boardlist.registerDate}" pattern="yyyy-MM-dd" /></td>
										...
										<td>
											...
											<button type="button" onclick="location.href='adminPage_BoardDelete?no=${boardlist.no}'" class="btn btn-primary btn-sm">삭제</button>
										</td>
									</tr>
								</c:forEach>
								</tbody>
