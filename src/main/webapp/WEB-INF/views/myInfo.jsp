                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <input type="hidden" id="user_no" value="${data[0].user_no }">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="name" type="text" value="${data[0].name }"/>
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid" style="margin-bottom:15px;"><button class="btn btn-primary btn-lg" id="myInfo_Update" type="button">정보수정</button></div>
                                    <div class="d-grid" style="margin-bottom:15px;"><button class="btn btn-primary btn-lg" id="myInfo_Delete" type="button">회원탈퇴</button></div>
                                    <div class="text-center mb-5">
